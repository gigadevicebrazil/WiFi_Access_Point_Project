...
---
How to Use
Build and flash the firmware to the GD32VW553 board.
Reset the board.
On a phone or computer, connect to the Wi-Fi network:
```text
GD32-LED_SeuNome
```
...
http://192.168.4.1/
```
Use the web page to control the LEDs.
...
Flash the firmware.
Connect to the Wi-Fi network created by the board.
Open the web page on a phone.
Control physical LEDs.
Understand the relationship between Wi-Fi, HTTP, sockets, JavaScript, RTOS tasks, and GPIO.
---
